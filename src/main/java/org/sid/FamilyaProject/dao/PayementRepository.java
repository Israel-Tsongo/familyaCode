...
public interface PayementRepository extends JpaRepository<Payement ,Long> {
	...
	public List<Payement> getPayementByMatric(String matric);
	...
	@Query(value= "SELECT id_paye,nom,matricule,`contrib_mensuel`,`date_payement` FROM `payement` INNER JOIN member WHERE member.id_member=payement.foreign_key_member_paying", nativeQuery=true )
